...
def make_roiwise_boxplot(r_values, sub_ids, plot_title=None, ax=None, ylabel = 'Spearman Correlation (r)', add_noiseceiling = None, fdr_pvals=None, diff_fdr_pvals = None, visualtype="violin"):
    ...
    model2colors = {
        ...
        'SocialGNN10s_trained10s-evc_r': (0.2980392156862745, 0.4470588235294118, 0.6901960784313725), 
        'SIMPLE10s-evc_r': (0.7686274509803922, 0.3058823529411765, 0.3215686274509804),
        'HR-evc_r': (0.8666666666666667, 0.5176470588235295, 0.3215686274509804),
        ...
        'SocialGNN10s_trained10s-HR': (0.614, 0.696, 0.830),
        'SIMPLE10s-HR': (0.873, 0.618, 0.627),
        'HR-SocialGNN10s_trained10s': (0.920, 0.735, 0.627),
        'HR-SIMPLE10s': (0.920, 0.735, 0.627),
        'HR-SocialGNN10s_trained10s+SIMPLE10s': (0.920, 0.735, 0.627),
        'HR-SocialGNN10s_trained10s+SIMPLE10s+ME10s_reduced': (0.920, 0.735, 0.627),
        }
